...
>
    ...
    <div class="mx-auto flex max-w-3xl flex-col gap-4">
            ...
            <div class="mt-5 space-y-3">
                ...
                <div class="grid gap-3 sm:grid-cols-3">
                    <div class="rounded-2xl border border-white/10 bg-black/20 px-4 py-3">
                        <p class="text-[9px] font-black uppercase tracking-[0.26em] text-zinc-500">Target</p>
                        <p class="mt-1 text-sm font-black text-white">Android 13+</p>
                    </div>
                    <div class="rounded-2xl border border-white/10 bg-black/20 px-4 py-3">
                        <p class="text-[9px] font-black uppercase tracking-[0.26em] text-zinc-500">Key step</p>
                        <p class="mt-1 text-sm font-black text-white">Accessibility access</p>
                    </div>
                    <div class="rounded-2xl border border-white/10 bg-black/20 px-4 py-3">
                        <p class="text-[9px] font-black uppercase tracking-[0.26em] text-zinc-500">Samsung</p>
        ...
        <section class="rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 shadow-xl shadow-black/20 ring-1 ring-white/5 backdrop-blur-xl">
            <div class="flex items-center justify-between gap-3">
                <div>
                    <p class="text-[9px] font-black uppercase tracking-[0.28em] text-zinc-500">Setup progress</p>
            ...
            >
                <div class="flex items-start gap-3">
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-black/20"
                        ...
                        <svg class="size-5" :class="status.phoneGranted ? 'text-emerald-200' : 'text-zinc-400'" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            >
                <div class="flex items-start gap-3">
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-black/20"
                        ...
                        <svg class="size-5" :class="status.smsGranted ? 'text-emerald-200' : 'text-zinc-400'" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            >
                <div class="flex items-start gap-3">
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-black/20"
                        ...
                        <svg class="size-5" :class="status.notificationsGranted ? 'text-emerald-200' : 'text-zinc-400'" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            >
                <div class="flex items-start gap-3">
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-black/20"
                        ...
                        <svg class="size-5" :class="status.batteryUnrestricted ? 'text-emerald-200' : 'text-zinc-400'" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            >
                <div class="flex items-start gap-3">
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-black/20"
                        ...
                        <svg class="size-5" :class="status.overlayGranted ? 'text-emerald-200' : 'text-zinc-400'" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
    ...
    <div class="fixed inset-x-0 bottom-0 z-10 border-t border-white/10 bg-[#050807]/96 px-4 py-4 backdrop-blur-xl">
        <div class="mx-auto flex max-w-3xl flex-col gap-3">
            <p
                ...
                :class="allCriticalGranted ? 'font-black text-emerald-300' : 'text-zinc-400'"
                x-text="allCriticalGranted
